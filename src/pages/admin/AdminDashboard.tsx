    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 ml-9">Manage your marketplace</p>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl p-6 mb-8 text-white">
          ...
          <p className="text-gray-400 text-sm">Here's an overview of your marketplace today.</p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            <div className="bg-gray-100 rounded-lg p-2.5 w-fit mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {quickActions.map((action) => (
              <Link key={action.to} to={action.to} className="group">
                <div className="border border-gray-100 hover:border-gray-200 rounded-xl p-4 transition-all hover:bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <span className="text-sm font-medium text-gray-700">Logs per Order</span>
                <span className="text-sm font-bold text-gray-900">
