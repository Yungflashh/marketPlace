...
const AdminWallet: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Manage User Wallets</h1>
                  ...
                  <tr key={user._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button
                        ...
                        className="text-gray-900 dark:text-gray-100 hover:text-blue-900"
                      >
                        Manage Wallet
                      </button>
                    </td>
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                ...
                <button
                  ...
                  className="text-gray-400 dark:text-gray-500 hover:text-gray-600 text-2xl"
                >
                  ✕
                </button>
              </div>
