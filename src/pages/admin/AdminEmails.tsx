        ...
        {suggestions && (suggestions.suggestions.length > 0 || suggestions.aiInsight) && (
          <div className="mb-6 bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            {suggestions.aiInsight && (
              <div className="px-5 py-3 bg-yellow-50 border-b border-yellow-100 flex items-start gap-2">
                <Wand2 className="w-4 h-4 text-yellow-700 mt-0.5 shrink-0" />
                <p className="text-sm text-yellow-900 leading-relaxed">{suggestions.aiInsight}</p>
              </div>
            )}
