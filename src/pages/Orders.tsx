  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {orders.length === 0 ? (
          <div className="text-center bg-white rounded-2xl border border-gray-100 py-16 px-4">
          ...
          <div className="space-y-4">
            {orders.map((order) => (
              ...
              >
                ...
                <div className="px-6 py-4 border-b border-gray-50">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-right">
                      <div className="flex items-center justify-end gap-1 text-[11px] text-gray-400 mb-1">
                ...
                {/* Footer */}
                <div className="px-6 py-3 bg-gray-50 border-t border-gray-50">
