...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-950 text-gray-400 dark:text-gray-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={l.to}>
                  <Link to={l.to} className="text-sm text-gray-500 dark:text-gray-400 hover:text-white transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5 mb-6">
              <li>
                <a href="mailto:support@shoplogshere.com" className="text-sm text-gray-500 dark:text-gray-400 hover:text-white transition-colors flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {['BTC', 'ETH', 'USDT (TRC20)', 'USDT (ERC20)'].map(m => (
                <span key={m} className="px-2.5 py-1 bg-gray-900 text-gray-400 dark:text-gray-500 text-[11px] font-medium rounded-md border border-gray-800">
                  {m}
                </span>
              ))}
            </div>
